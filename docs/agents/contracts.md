...
- [`src/inferna/agents/contract.py`](../../src/inferna/agents/contract.py) — module docstring (the canonical `@pre` / `@post` reference)

- [`src/inferna/agents/tools.py`](../../src/inferna/agents/tools.py) — `Annotated[]` constraint markers (`Ge`, `Le`, `Pattern`, ...) and `coerce_args`
