...
from inferna._vendor.markupsafe import escape
from inferna._vendor.markupsafe import Markup
...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(
        ...
        self.writeline("from inferna._vendor.jinja2.runtime import " + ", ".join(exported_names))
